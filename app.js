...
const STICKERS = {
  ...
  thaiarch: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  predefinedStickers.addEventListener("click", (e) => {
    ...
    if (stickerName === "none") {
      ...
      const svgMarkup = STICKERS[stickerName];
      activeLogoDataUrl = svgToDataUrl(svgMarkup);
